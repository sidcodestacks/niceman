package com.example.android.niceman;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == INTENT_REQUEST_GET_IMAGES && resultCode == Activity.RESULT_OK) {
            ...
            for (int i = 0; i < imageUris.size(); i++) {
                ...
                //Log.d("print image path",imageUris.get(i).getPath());
            }
            Toast.makeText(activity, R.string.toast_images_added, Toast.LENGTH_LONG).show();
            ////////////------POINT OF IMAGE BEING Approved------/////////////
            //            getImages();
...
//
//        startActivityForResult(intent,INTENT_REQUEST_GET
// _IMAGES);
//
//    }
